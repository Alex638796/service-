...
def is_owner(message: Message) -> bool:
    """Returns True if the sender is the configured owner."""
...
async def owner_required(message: Message) -> bool:
    ...
    Silent deny for non-owners (no response sent — keeps bot private).
    """
...
async def allowed_or_owner_required(message: Message) -> bool:
    ...
    Alias for is_allowed_or_owner() for use as an explicit guard.
    """
